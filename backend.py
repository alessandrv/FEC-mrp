...
# Add a new product
@app.post("/add_disponibilita_articolo")
async def add_product_availability(request: Request):
    ...
    try:
        ...
        if cursor is not None:
            cursor.close()
# Add a new product
@app.post("/add_disponibilita_articolo_commerciali")
...
@app.put("/update_disponibilita_articolo")
...
@app.put("/update_disponibilita_articolo_commerciali")
...
# Delete a product
@app.delete("/delete_disponibilita_articolo/{posizione}")
...
# Delete a product
@app.delete("/delete_disponibilita_articolo_commerciali/{posizione}")
...
@app.put("/update_disponibilita_articoli_order")
...
# Update the order of products
@app.put("/update_disponibilita_articoli_order_commerciali")
...
@app.get("/get_article_description/{code}")
